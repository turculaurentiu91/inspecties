...
<tr>
  ...
  add_filter( 'wp_mail_content_type', 'noodverlichting\set_html_mail_content_type' );   // Edit callback namespace
  \wp_mail($email, "Offerte Hoppenbrouwers Techniek - Noodverlichting", $body, '', file_path($postcode, $huisnummer));
    
  remove_filter( 'wp_mail_content_type', 'noodverlichting\set_html_mail_content_type' );    // Edit callback namespace
}